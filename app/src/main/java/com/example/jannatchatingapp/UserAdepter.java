...
public class UserAdepter extends RecyclerView.Adapter<UserAdepter.ViewHolder> {
    ...
    public UserAdepter(HomeActivity homeActivity, ArrayList<Users> usersArrayList) {
    ...
    public void onBindViewHolder(@NonNull ViewHolder holder, int position) {
        ...
        Picasso.get().load(users.image_uri).into(holder.user_profile);
        ...
        holder.itemView.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
               ...
               intent.putExtra("ReciverImage",users.getImage_uri());
